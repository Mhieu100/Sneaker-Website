        ...
        <div className="flex items-center gap-3">
          ...
          <div className="grid items-center">
            <h1 className="text-base font-medium text-slate-900">
              Your Cart <span className="bg-theme-cart rounded text-xs font-normal px-1 py-0.5 text-slate-100">(Items)</span>
            </h1>
          </div>
        </div>
        <div className="flex items-center">
          <button className="rounded bg-theme-cart active:scale-90 p-0.5"> 
