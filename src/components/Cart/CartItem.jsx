...
import { MinusIcon, PlusIcon, TrashIcon
  ...
  return (
    <div className="flex item-center justify-between w-full px-5">
      <div className="flex items-center gap-5">
        ...
        <div className="grid items-center gap-4">
          ...
          <div className="flex items-center justify-around w-full">
            ...
            >
              <MinusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-white strorle-[2]" />
            </button>
            <div className="bg-theme-cart rounded text-white w-7 h-6 lg:h-5 lg:w-6 font-medium lg:text-xs flex items-center justify-center">
              {cartQuantity}
            </div>
            <button
              ...
              className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90"
            >
              <PlusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-white strorle-[2]" />
            </button>
          </div>
        </div>
      </div>
      <div className="grid gap-5 items-center">
        ...
        <div className="grid items-center justify-center">
          <button
            className="bg-theme-cart rounded grid items-center justify-items-center cursor-pointer"
            onClick={onRemoveItem}
          >
            <TrashIcon className="w-5 h-5 text-white p-1 lg:p-0.5" />
          </button>
        </div>
      </div>
    </div>
