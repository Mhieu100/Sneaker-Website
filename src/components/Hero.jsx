  ...
  return (
    <>
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative grid justify-items-center items-center opacity-100 z-20 nike-container">
          <div className="grid justify-items-center items-center mt-28 md:mt-24">
            ...
            <div className="grid item-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto">
              {videos.map((val, i) => (
          ...
          <div>
            <img
              src={img}
              alt="hero-img/img"
              className="w-auto h-[45vh] lg:h[35vh] md:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0"
            />
          </div>
        </div>
      </div>
